...
pp_doctor_run() {
  ...
  local checks="doctor_check_bash doctor_check_jq doctor_check_llm doctor_check_openai_key \
                doctor_check_settings_json doctor_check_statusline_wired doctor_check_subagent_statusline_wired doctor_check_dim_gate_progress doctor_check_dim_data_quality doctor_check_hooks_wired \
